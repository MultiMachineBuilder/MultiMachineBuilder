 ...
 * @author oskar
 */
public class LockedStackedInventory implements Inventory{
	...
	private class Record implements ItemRecord{
		...
		public boolean exists() {
			return LockedStackedInventory.this.entry == entry;
		}
		...
		@Override
		public int amount() {
			if(LockedStackedInventory.this.entry == entry) return amount;
			return 0;
		}

		@Override
		public Inventory inventory() {
			return LockedStackedInventory.this;
		}
		...
		public int insert(int amount) {
			if(LockedStackedInventory.this.entry != entry) return 0;
			return LockedStackedInventory.this.insert(entry, amount);
		}

		@Override
		public int extract(int amount) {
			if(LockedStackedInventory.this.entry != entry) return 0;
			return LockedStackedInventory.this.extract(entry, amount);
		}
	}
