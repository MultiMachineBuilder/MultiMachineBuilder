...
public class OBJLoader {
	private static Debugger debug = new Debugger("ModelLoader");
	public static RawModel loadObjModel(String fileName, Loader loader) throws FileNotFoundException {
		...
		float[] verticesArray = null, texturesArray = null, normalsArray = null;
		...
		try {
			...
			debug.pstm(e, "Unable to load "+fileName+ ".obj");
		}
