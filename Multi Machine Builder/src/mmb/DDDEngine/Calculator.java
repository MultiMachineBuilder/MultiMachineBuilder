...
public class Calculator {
	static double t = 0;
	static Vector3d W1, W2, ViewVector, RotationVector, DirectionVector, PlaneVector1, PlaneVector2;
	static Plane P;
	...
	static Vector3d getRotationVector(double[] ViewFrom, double[] ViewTo)
	{
		...
		if(ViewFrom[0]<ViewTo[0])
			...
			Vector3d V = new Vector3d(xRot, yRot, 0);
		return V;
	}
	
	static void SetPrederterminedInfo()
	{
		ViewVector = new Vector3d(Screen.ViewTo[0] - Screen.ViewFrom[0], Screen.ViewTo[1] - Screen.ViewFrom[1], Screen.ViewTo[2] - Screen.ViewFrom[2]);			
		DirectionVector = new Vector3d(1, 1, 1);				
