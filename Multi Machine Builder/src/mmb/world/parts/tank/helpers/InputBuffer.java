...
import mmb.world.parts.tank.FluidStorage;
import mmb.world.parts.tank.IInputBuffer;
...
public class InputBuffer implements IInputBuffer {
	...
	/*
	 * (non-Javadoc)
	 * @see mmb.world.parts.tank.IInputBuffer#flush()
	 */
	public void flush() {
	...
	/*
	 * (non-Javadoc)
	 * @see mmb.world.parts.tank.IInputBuffer#addAcceptableInput(mmb.material.types.Fluid)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see mmb.world.parts.tank.FluidStorage#getContents()
	 */
	...
	/* (non-Javadoc)
	 * @see mmb.world.parts.tank.Refiller#refill(mmb.material.types.Fluid, double)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mmb.world.parts.tank.FluidStorage#setAmount(mmb.material.types.Fluid, double)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mmb.world.parts.tank.FluidStorage#getAmount(mmb.material.types.Fluid)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mmb.world.parts.tank.FluidStorage#supports(mmb.material.types.Fluid)
	 */
	@Override
